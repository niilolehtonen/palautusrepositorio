...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_onnistuu_kahdella_eri_tuotteella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_onnistuu_kahdella_samalla_tuotteella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_onnistuu_kun_toinen_tuote_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uusi_viitenumero_generoituu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        kauppa.tilimaksu("pekka", "12345")
        pankki_mock.tilisiirto.assert_called_with("pekka",42,"12345","33333-44455",5)
        viitegeneraattori_mock.uusi.return_value = 25
        kauppa.aloita_asiointi()
        kauppa.lisaa_koriin(2)
        kauppa.tilimaksu("tomi", "12321")
        pankki_mock.tilisiirto.assert_called_with("tomi",25,"12321","33333-44455",3)
    def test_poistaminen_toimii(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
